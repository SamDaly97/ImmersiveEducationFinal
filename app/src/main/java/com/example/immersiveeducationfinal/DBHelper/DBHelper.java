...
public class DBHelper extends SQLiteAssetHelper {
    ...
    private static final String DB_NAME = "IEDBBB1.db";
    ...
    /*
    GET 15 QUESTION FROM DB BY CATEGORY
     */
    public List<Question> getQuestionByCategory(int category)
    {
        SQLiteDatabase db = instance.getWritableDatabase();

        Cursor cursor = db.rawQuery(String.format("SELECT * FROM Question WHERE CategoryID = %d ORDER BY RANDOM() LIMIT 15",category),null);
